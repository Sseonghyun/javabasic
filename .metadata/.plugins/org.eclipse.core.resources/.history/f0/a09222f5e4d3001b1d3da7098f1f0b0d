...
public class Child2 extends Parent {
	...
	// Child2의 getB 메서드는 Parent의 b의 접근합니다.
	...
	// b값은 음수가 될 수 없습니다.
	// 작성된 setB를 이용해 Main.2.java에서 b값을 변경하는 로직도
	// 추가해보세요.
	...
	// getter는 getB()처럼 특정 변수의 수치를
	// 콘솔에 찍어주는 유형도 있지만
	// 좀 더 많이 사용하는 유형은 해당 변수의 값을
	// return 구문을 이용해 호출위치로 가져다 주는 형태를 더 많이 씁니다.
	// int를 리턴자료로 가지는 getBInt()를 추가로 아래에 작성해주세요.
	// Main2에서 getBint()를 이용해 조회한 값을 출력해주세요.
	public int getBInt() {
		return this.b;
	}
