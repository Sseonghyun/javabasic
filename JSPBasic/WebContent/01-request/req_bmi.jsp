...
4. sumbit 버튼을 사용하면 action= 에 지정한 페이지로 자료가 전송됩니다.
req_bmi.jsp ==> req_bmi_result.jsp
 --%>
<form action ="req_bmi_result.jsp" method="post">
  키 :
  <input type = "text" name = "height" size="10px">cm<br/>
  체중 :
  <input type = "text" name = "weight" size="10px">kg<br/>
