...
public class Boxer {
	...
	public void showAllData() {
		System.out.println("복서의 현재 레벨은 : " + level);
		System.out.println("복서의 현재 경험치는: " + exp);
		System.out.println("복서의 현재 체력은 : " + hp);
		System.out.println("복서의 현재 마나는 : " + mp);
		System.out.println("복서의 현재 공격력은 : " + atk);
		System.out.println("복서의 현재 방어력은 : " + df);
		System.out.println("------------------------");
	}
}
