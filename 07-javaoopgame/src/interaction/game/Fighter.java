...
// 직업3개 , 몬스터3종 정의
// 몬스터는 체력, 공격력, 방어력 수치를 가집니다.
// 그리고 공격하기 명령을 가집니다.
// 공격하기는 사용자가 특정 몬스터를 공격했을때 상호작용을 용도로 작성해주세요
// 유저는 체력, 공격력, 방어력, 마나, 레벨, 경험치를 가집니다.
// 유저는 일반공격 huntXX(몬스터이름)을 가집니다.
public class Fighter {
	...
	public void showAllData() {
		System.out.println("격투가의 현재 레벨은 : " + this.level);
		System.out.println("격투가의 현재 경험치는: " + this.exp);
		System.out.println("격투가의 현재 체력은 : " + this.hp);
		System.out.println("격투가의 현재 마나는 : " + this.mp);
		System.out.println("격투가의 현재 공격력은 : " + this.atk);
		System.out.println("격투가의 현재 방어력은 : " + this. df);
		System.out.println("------------------------");
	}
}
