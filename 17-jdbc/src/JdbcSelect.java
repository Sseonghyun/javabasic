...
public class JdbcSelect {
	...
	public static void main(String[] args) {
		...
		try {
		    ...
		    // 다음자료가 조회되면  true, 조회되지 않으면 false를 출력합니다.
		    ...
		    // 컬럼번호는 1번부터 시작합니다.
		    System.out.println(rs.getInt(1)); //컬럼번호를 쓰는방식
		    // rs.get자료형("컬럼이름"); 을 대신 사용할 수 있습니다.
		    // EX : System.out.println(rs.getInt("emp_no"));
		    
		    // 하단에 10002번도 조회해서 콘솔에 찍어주세요.
		    rs.next(); // 0번에서 1번으로
		    System.out.println(rs.getInt("emp_no")); //컬럼이름을 쓰는방식
