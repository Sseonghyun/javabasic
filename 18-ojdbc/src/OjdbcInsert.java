...
public class OjdbcInsert {
	...
	public static void main(String[] args) {
        ...
        try {
			...
			// pstmt 변수를 생성해놓은 다음, set자료형(?순서, 집어넣을 변수)
			// 를 이용해 ?를 모두 채워줍니다.
			pstmt = con.prepareStatement(sql);
			pstmt.setInt(1, num); // 1번?자리에 1을 넣겠다
			pstmt.setString(2, str); // 2번?자리에 "test"를 넣겠다
